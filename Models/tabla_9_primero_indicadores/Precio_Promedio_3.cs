...
{
    public class Precio_Promedio_3
    {
        ...
        public Devolucion devolver_Precio_Promedio_3(int anioant, int anio, string mes, Compania compania1, int compania, decimal idDB, MonedaEmpresa moneda1)
        {
            SqlConnection conexion = new SqlConnection(con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
            indicadorf = indicadorBC.datosindicador(3);
            ...
            SqlCommand sqlCmd = new SqlCommand("[CifrasNotables_PrecioPromedio_3]", conexion);
        ...
        public Devolucion devolver_Precio_Promedio_mesanual(int anioant, int anio, string mes, Compania compania1, int compania, decimal idDB, MonedaEmpresa moneda1, decimal proidd)
        {
            SqlConnection conexion = new SqlConnection(con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
            ...
            if (conexion.State != ConnectionState.Open) conexion.Open();
            SqlCommand sqlCmd = new SqlCommand("[performancetop5_pp]", conexion);
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandTimeout = 0;
            sqlCmd.Parameters.AddWithValue("@iddbempresa", idDB);
            sqlCmd.Parameters.AddWithValue("@companiaid", compania);
        ...
        public Devolucion devolver_Precio_Promedio_mesanual_performanceregion(int anioant, int anio, string mes, Compania compania1, int compania, decimal idDB, MonedaEmpresa moneda1, decimal ciudadid)
        {
            SqlConnection conexion = new SqlConnection(con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
            ...
            if (conexion.State != ConnectionState.Open) conexion.Open();
            SqlCommand sqlCmd = new SqlCommand("[performanceregion_pp]", conexion);
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandTimeout = 0;
            sqlCmd.Parameters.AddWithValue("@iddbempresa", idDB);
            sqlCmd.Parameters.AddWithValue("@companiaid", compania);
