...
namespace IndicadoresCore.Models.tabla_9_primero_indicadores
{
    public class Gross_Profit_4
    {
        ...
        public Devolucion devolver_gross_profit_4(int anioant, int anio, string mes, Compania compania1, int compania, decimal idDB, MonedaEmpresa moneda1)
        {
            SqlConnection conexion = new SqlConnection(con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
            indicadorf = indicadorBC.datosindicador(5);
