...
namespace IndicadoresCore.Models.tabla_9_primero_indicadores
{
    public class Cantidad_1 
    {
        ...
        public Devolucion devolver_cantidad_1(int anioant, int anio, string mes, Compania compania1, int compania, decimal idDB , MonedaEmpresa moneda1)
        {
        ...
        public Devolucion devolver_cantidad_mesanual(int anioant, int anio, string mes, Compania compania1, int compania, decimal idDB, MonedaEmpresa moneda1, decimal proidd)
        {
            SqlConnection conexion = new SqlConnection(con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
        ...
        public Devolucion devolver_cantidad_mesanual_performanceregion(int anioant, int anio, string mes, Compania compania1, int compania, decimal idDB, MonedaEmpresa moneda1, decimal ciudadid)
        {
            SqlConnection conexion = new SqlConnection(con);
            Devolucion devolucion = new Devolucion();
            Indicador indicadorf = new Indicador();
